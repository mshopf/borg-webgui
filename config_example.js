{
    ...
    //data: [ { file: '*-data-tree.bin', restore: '/path/to/RESTORE/to', borg_args: ['--sparse', '--strip-components', '2'] } ],
    data: [ { file: 'data/borg-backup-data-tree.bin', restore: '/space/nobackup/_RESTORE', borg_args: ['--sparse'] } ],
    auth: {
